...
(deftest test-all-the-helpers
  ...
  (is (not (all-signaled-ready? konsent-discussed)))
  (is (all-signaled-ready? konsent-all-marked-ready))
  ...
  (is (voting-over? konsent-voted-veto))
  (is (not (voting-over? konsent-vote-incomplete)))
  (is (voting-over? konsent-vote-force-incomplete-voting-minor))
  ...
  (is (voting-over? konsent-vote-force-incomplete-voting-major)))
